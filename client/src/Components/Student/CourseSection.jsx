...
const CourseSection = () => {
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
      ...
      <div className="grid grid-cols-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 
                gap-4 px-4 md:px-0 md:my-16 my-10">
      ...
      <Link to={'/course-list'} onClick={() => scrollTo(0, 0)}
        className='text-gray-500 border border-gray-500/30 px-10 py-3  rounded-3xl'

...
const CourseDetails = () => {
  ...
  const fetchCourseData = async () => {
    const requiredCourse = allCourses.find(course => course._id === id)
    setCourseData(requiredCourse)
  }
  ...
  return courseData ? (
    ...
    -z-1 bg-gradient-to-b from-cyan-100/70' ></div>
        ...
        <div className='max-w-xl x-10 text-gray-500'>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>Nikhil God</span></p>
